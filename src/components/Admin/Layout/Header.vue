<template>
  <router-link to="/admin/dashboard" class="logo-container">
    <img src="@/assets/img/Admin/admin-page-logo.svg" alt="" class="logo"/>
  </router-link>
...
import {profile} from "@/services/Common/auth";
